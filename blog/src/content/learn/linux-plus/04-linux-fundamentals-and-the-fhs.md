...
<details class="deeper">
<summary>If you already administer Linux: /opt, /usr/local, and /srv, and who is allowed to write where</summary>
...
<details class="deeper">
<summary>If you already administer Linux: which directories are memory, and which are not really files</summary>
