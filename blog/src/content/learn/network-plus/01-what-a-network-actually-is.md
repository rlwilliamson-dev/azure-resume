...
<text x="45" y="166">theirs is 192.168.2, so not local</text>
<text x="45" y="184">not local means hand it to a router</text>
<text x="45" y="202">and there is no router here</text>
</g>
<line x1="303" y1="142" x2="417" y2="142" stroke="currentColor" stroke-width="2.4"/>
<text x="360" y="132" text-anchor="middle" font-size="10" fill-opacity="0.75">one cable</text>
<text x="360" y="170" text-anchor="middle" font-size="10" fill-opacity="0.75">carrying nothing</text>
<rect x="417" y="54" width="286" height="176" rx="4" fill="currentColor" fill-opacity="0.08" stroke="currentColor" stroke-opacity="0.55"/>
<text x="560" y="78" text-anchor="middle" font-size="11.5">h2</text>
<text x="560" y="96" text-anchor="middle" font-size="10.5" fill-opacity="0.85">192.168.2.20/24</text>
<rect x="433" y="110" width="254" height="104" rx="3" fill="currentColor" fill-opacity="0.06" stroke="currentColor" stroke-opacity="0.4" stroke-dasharray="5 4"/>
<g font-size="10">
<text x="445" y="146">up, addressed and healthy</text>
...
other direction in [Network basics: addresses and routes](/learn/linux-plus/network-basics-addresses-and-routes), starting from the four things a host needs before
