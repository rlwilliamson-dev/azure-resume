...
- **Print mode**. A "↓ PDF" button toggles browser print, with a dedicated print stylesheet that produces a clean one-to-two page traditional resume
...
[**Ryan Williamson**](https://linkedin.com/in/rlwilliamson), DevOps Engineer with 8+ years building and executing Azure CI/CD and DevSecOps practices at scale. Multi-cloud experience across Azure, AWS, and GCP, including a multi-year data center migration.
